...
const Color blarColor = Color(0x29000000);
 const Color bluishWhiteColor= Color(0xffCED7ED);
 const Color blackColor = Color(0xff000000);
 const Color violetColor= Color(0xff133386);
 const Color darkVioletColor= Color(0xff181945);
 const Color whiteBluishColor= Color(0xffEFF3FF);
